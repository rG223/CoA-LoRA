...
FILE_NAMES_DICT = {
    # 7B
    "llama-2-7b/lpq-64/c4"  : "/mnt/data1/big_file/yerg/data/export/llama-2-7b-1024.ilp.ranks-64.data-True.pth",
    "llama-2-7b/lpq-64/None": "/mnt/data1/big_file/yerg/data/export/llama-2-7b-1024.ilp.ranks-64.data-False.pth",
    "llama-2-7b/lora/c4"    : "/mnt/data1/big_file/yerg/data/export/llama-2-7b-1024.ilp.ranks-None.data-True.pth",
    "llama-2-7b/lora/None"  : "/mnt/data1/big_file/yerg/data/export/llama-2-7b-1024.ilp.ranks-None.data-False.pth",
    # 70B
    "llama-2-70b/lpq-64/c4"  : "/mnt/data1/big_file/yerg/data/export/llama-2-70b-1024.ilp.ranks-64.data-True.pth",
    "llama-2-70b/lpq-64/None": "/mnt/data1/big_file/yerg/data/export/llama-2-70b-1024.ilp.ranks-64.data-False.pth",
    "llama-2-70b/lora/c4"    : "/mnt/data1/big_file/yerg/data/export/llama-2-70b-1024.ilp.ranks-None.data-True.pth",
    "llama-2-70b/lora/None"  : "/mnt/data1/big_file/yerg/data/export/llama-2-70b-1024.ilp.ranks-None.data-False.pth",
}
...
def create_qconfig_and_sensitivity_dict_LLaMA(
    ...
    outputs[0]['inputs_path'] = FILE_NAMES_DICT["llama-2-7b/lora/None"]
