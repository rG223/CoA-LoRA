...
FILE_NAMES_DICT = {
    "roberta-large/lpq-64/c4"  : "/mnt/data1/big_file/yerg/data/roberta/roberta-large.ilp.ranks-64.data-True.pth",
    "roberta-large/lpq-64/None": "/mnt/data1/big_file/yerg/data/roberta/roberta-large.ilp.ranks-64.data-False.pth",
    "roberta-large/lora/c4"    : "/mnt/data1/big_file/yerg/data/roberta/roberta-large.ilp.ranks-None.data-True.pth",
    "roberta-large/lora/None"  : "/mnt/data1/big_file/yerg/data/roberta/roberta-large.ilp.ranks-None.data-False.pth",
    "roberta-large-c4-10000-data": "/home/yerg/LoRASync/lq-lora/export/roberta-large.fisher_dict.c4.length-default.nsamples-10000.pth"
}
...
def create_qconfig_and_sensitivity_dict_RoBERTa(
    ...
    outputs[0]['inputs_path'] = FILE_NAMES_DICT["roberta-large-c4-10000-data"]
